...
class _KalpPageState extends State<Kalp> {
  final Map<String, bool> _symptoms = {
    'Göğüs ağrısı  ': false,
    'Boğazda ağrı / yanma': false,
    'Kulaklarda dolgunluk  ': false,
    'Burunda tıkanıklık / akıntı ': false,
    'Tat veya koku kaybı ': false,
    'Hapşırma ': false,
    'Ağız kuruluğu  ': false,
    'Baş/Göğüs ağrısı  ': false,
    'Kalp ritim bozukluğu ': false,
    'Çarpıntı ': false,
  };
